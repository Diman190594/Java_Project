...
//        2. Реализовать ввод для неограниченного количества человек и выход из режима по команде exit.
//           Вывести список введённых данных в формате Иванов И.И. в порядке ввода.
//        3. вывести отсортированными по возрасту в формате Иванов И.И. 16
//        4. вывести отсортированными по возрасту и полу в формате Иванов И.И. 16 М
        ...
        System.out.print("Введите ФИО, возвраст, пол (через запятую): ");
        System.out.print("Введите exit, чтобы выйти из режима ввода.");
...
////            char e = n1.split(", ")[2].toLowerCase().charAt(0);
////            return d - e;
////        });
